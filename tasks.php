...
if (isset($_SESSION["role"]) && isset($_SESSION["id"]) && $_SESSION["role"] == "admin") {
    ...
    list($text, $tasks, $num_task) = filter_tasks($connection);
	...
	<div class="body">
		...
		<section class="section-1">
			...
			<h4 class="title-2">
				...
				<a href="tasks.php?status=In progress">In progress</a>
            ...
            <table class="main-table">
                ...
                <tr>
                    ...
                    <td>
                        <?php
                            // Anzeige des vollständigen Namens des zugewiesenen Benutzers
