	...
	<div class="body">
		...
		<section class="section-1">
            ...
            <form class="form-1" method="POST" action="app/update-task.php">
                ...
                <div class="input-holder">
                    <label>Snooze</label>
                    <input type="date" name="due_date" value="<?=$task["due_date"]?>"  class="input-1" placeholder="Snooze"><br>
                </div>
                <div class="input-holder">
                        ...
                        <?php 
                            ...
                            if ($users != 0) {
                                foreach ($users as $user) {
                                    // Wenn der Aufgabe ein Benutzer zugewiesen ist, diesen als ausgewählt markieren
